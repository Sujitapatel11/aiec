        ...
        <div>
          ...
          <div className="mt-5 flex items-center gap-3">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="w-9 h-9 bg-gradient-to-br from-purple-500 via-pink-500 to-orange-400 rounded-lg flex items-center justify-center hover:opacity-90 transition-opacity"
