...
export default function WhatsAppButton() {
  const number = import.meta.env.VITE_WHATSAPP || '919999999999';
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 group">
      ...
      <a
        ...
        className="relative bg-green-500 hover:bg-green-600 text-white rounded-full w-14 h-14 flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-200 hover:scale-110"
      >
        {WA_ICON}
      </a>
    </div>
